function plotData(pDat,mDat,state,stiTm,fname)
...
if hfig
    ...
    wid=min(1500,totmin*d0);
    hfg=figure('position',[10,200,wid,400]);
...
text(-0.01*wid*a0,hei*1/fLen,'0-','fontsize',16);
text(-0.02*wid*a0,hei*11/fLen,'10-','fontsize',16);
text(-0.02*wid*a0,hei*24/fLen,'Hz','fontsize',16);
ylm=[0,25]*hei/fLen;
set(gca,'ylim',ylm);
%show EMG----------------------------------------------
...
set(gca,'xlim',[emgT(1),emgT(end)]/60,'fontsize',16,'YTick',[],'Box','on','linewidth',1);
set(gca,'ylim',ylm);
%set(gca,'XTick',0:5:30);
y0=100*(floor(h0/100));
text(-0.03*totmin*a0,y0/2,[num2str(y0/2),'-'],'fontsize',16);
text(-0.02*totmin*a0,0,'uV','fontsize',16);
